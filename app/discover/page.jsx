    ...
    <div className='max-w-md text-center mx-auto mt-10 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md'>
      ...
      <div className='flex justify-between'>
        <button
          ...
          className='w-full p-3 mr-2 bg-red-500 text-white rounded-md hover:bg-red-600 transition duration-300'
        >
          Dislike
        </button>
        <button
          onClick={handleLike}
          className='w-full p-3 ml-2 bg-green-500 text-white rounded-md hover:bg-green-600 transition duration-300'
        >
          Like
        </button>
      </div>
